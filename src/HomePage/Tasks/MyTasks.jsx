...
const MyTasks = props => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(`https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/apis/employees/tasksAssignedTo/${employeeId}`,{
          headers: {
  ...
  const taskTypeChange = async (event) => {
    ...
    if (event.target.value === "allTasks") {
      url = `https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/apis/employees/tasksAssignedTo/${employeeId}`;
    } else if (event.target.value === "overdueTasks") {
      url = `https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/apis/employees/OverdueTasks/PersonId/${employeeId}`;
    } else if (event.target.value === "pendingTasks") {
      url = `https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/apis/employees/PendingTasks/PersonId/${employeeId}`;
    } else if (event.target.value === "completedTasks") {
      url = `https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/apis/employees/CompletedTasks/PersonId/${employeeId}`;
    }
