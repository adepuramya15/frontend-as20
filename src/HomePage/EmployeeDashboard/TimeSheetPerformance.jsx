...
const TimesheetPerformance = () => {
    ...
    useEffect(() => {
        const fetchData = async (status) => {
          ...
          try {
            const response = await axios.get(`https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/api/timesheets/employeeId/${employeeId}/total/timesheets`, {
                headers: {
