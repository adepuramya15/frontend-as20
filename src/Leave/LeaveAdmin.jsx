...
export default function LeaveApprovalDashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(`https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/api/leaves/manager/${managerId}`, {
          method:'GET',
          headers:{
  ...
  const handleApprove = async (id) => {
    ...
    try {
      const token = localStorage.getItem('token')
      await axios.put(`https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/api/leaves/approve/${id}`, null,  {
  ...
  const handleReject = async () => {
    ...
    const token = localStorage.getItem('token')
      await axios.put(`https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/api/leaves/reject/${selectedLeaveId}/${rejectionReason}`, null,  {
