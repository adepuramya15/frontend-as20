...
const LeaveSheet = () => {
 ...
 const fetchLeaveSheet =  async () => {
  try{
    ...
    const response = await axios.get("https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/api/getSheets", {
        method:'GET',
        headers:{
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      if(isSubmitted && leaveId){
        const response =  await axios.put(`https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/api/updateSheet/${leaveId}`, leaveData, {
        ...
        setIsSubmitted(true); // Ensure it remains submitted
          ...
          const response = await axios.post(
            "https://adepuweb20-g4cyfqdre8ftfea5.canadacentral-01.azurewebsites.net/api/submitSheet",
            leaveData, {
